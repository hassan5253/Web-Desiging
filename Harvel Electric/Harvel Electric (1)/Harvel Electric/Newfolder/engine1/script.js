...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"basic",prev:"",next:"",duration:10*100,delay:20*100,outWidth:978,outHeight:200,width:978,height:200,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:true,controls:true});
  ...
  function checkForm()
  {
	...
	{
		alert("For example:info@harvelelectric.com");
		return false;
	}
